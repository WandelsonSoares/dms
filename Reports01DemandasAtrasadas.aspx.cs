...
public partial class Reports01DemandasAtrasadas : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            usuario.LogIsert(appSession.FullName, "Relatório 01 - Demandas atrasadas", "Acessou relatório de demandas atrasadas.", appSession.IP);
        }
    ...
    protected void DropDownListArea_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            GridView1.DataSource = SqlDataSourceAtrasadasArea;
            GridView1.DataBind();
        }
        else
        {
            GridView1.DataSource = SqlDataSourceAtrasadas;
            GridView1.DataBind();
        }
    }
    ...
    public void EnviarEmailPrepara(object idArea)
    {
        ...
        try
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                EnviarEmail(emailDestinatarios, EmailResponsavelSetor, "DMS - Demandas Atrasadas (" + DropDownListArea.SelectedItem.Text + ")", ConteudoHTML);
