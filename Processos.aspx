<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Processos.aspx.cs" Inherits="Processos" %>
                            ...
                            <div>
                                <div>
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li role="presentation" class="active"><a href="#">Processos</a></li>
                                            ...
                                            <td style="width: 0%;">
                                                <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Height="100%" Width="400px" Visible="False">
                                                    <div style="vertical-align: central; height: 100%; padding: 4px">
                                                        ...
                                                        <asp:Label ID="lblArea" runat="server" CssClass="fontePadrao" Height="18px" Text="Área"></asp:Label>
                                                        <br />

                                                        <asp:DropDownList ID="DropDownListArea" runat="server" Width="300px"></asp:DropDownList>
                                            ...
                                            <td style="width: 100%; padding: 4px">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <div>
                                                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" Font-Names="Tahoma" Font-Size="9pt" ForeColor="#333333" GridLines="None" Width="100%" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("ProcessoId", "~/Subprocessos.aspx?id={0}")  %>' Text="Abrir"></asp:HyperLink>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="ProcessoId" HeaderText="Id" ReadOnly="True" SortExpression="ProcessoId">
                                                                        <ItemStyle Width="20px" />
                                                                    </asp:BoundField>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SGC_NET_V1ConnectionString1 %>" SelectCommand="SELECT Processos.ProcessoId, Processos.Nome, Areas.Nome AS Area, Usuarios.Nome AS Responsavel FROM Processos INNER JOIN Areas ON Processos.AreaId = Areas.AreaId INNER JOIN Usuarios ON Processos.ResponsavelId = Usuarios.UserID WHERE (Processos.AreaId = @AreaId)">
                                                            <SelectParameters>
                                                                <asp:QueryStringParameter Name="AreaId" QueryStringField="id" />
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
