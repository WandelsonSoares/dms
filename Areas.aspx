                        ...
                        <ContentTemplate>
                            <div>
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li role="presentation" class="active"><a href="#">Áreas</a></li>
                                            ...
                                            <td style="width: 0%;">
                                                <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Height="100%" Width="400px" Visible="False">
                                                    <div style="vertical-align: central; height: 100%; padding: 4px">
                                                        ...
                                                        <asp:Label ID="lblSetor" runat="server" CssClass="fontePadrao" Height="18px" Text="Setor"></asp:Label>
                                                        <br />

                                                        <asp:DropDownList ID="DropDownListSetor" runat="server" Width="300px"></asp:DropDownList>
                                            ...
                                            <td style="width: 100%; padding: 4px">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <div>
                                                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" Font-Names="Tahoma" Font-Size="9pt" ForeColor="#333333" GridLines="None" Width="100%" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("AreaId", "~/Processos.aspx?id={0}")  %>' Text="Abrir"></asp:HyperLink>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="AreaId" HeaderText="Id" ReadOnly="True" SortExpression="AreaId">
                                                                    <ItemStyle Width="20px" />
                                                                    </asp:BoundField>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SGC_NET_V1ConnectionString1 %>" SelectCommand="SELECT Areas.AreaId, Areas.Nome, Setores.Nome AS Setor, Usuarios.Nome AS Responsavel FROM Usuarios INNER JOIN Areas ON Usuarios.UserID = Areas.ResponsavelId INNER JOIN Setores ON Areas.SetorId = Setores.SetorId WHERE (Areas.SetorId = @SetorId) ORDER BY Areas.Nome">
                                                            <SelectParameters>
                                                                <asp:QueryStringParameter Name="SetorId" QueryStringField="id" />
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
