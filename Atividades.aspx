                                            ...
                                            <td style="width: 0%;">
                                                <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Height="100%" Width="400px" Visible="False">
                                                    <div style="vertical-align: central; height: 100%; padding: 4px">
                                                        ...
                                                        <asp:Label ID="lblSubprocesso" runat="server" CssClass="fontePadrao" Height="18px" Text="Subprocesso"></asp:Label>
                                                        <br />

                                                        <asp:DropDownList ID="DropDownListSubprocesso" runat="server" Width="300px"></asp:DropDownList>
                                                        ...
                                                        <asp:Button ID="btnEtapas" runat="server" CssClass="btn-default" Text="Etapas da Atividade" Width="200px"/>
                                                        <br />
                                                        <br />
                                            ...
                                            <td style="width: 100%; padding: 4px">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <div>
                                                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" Font-Names="Tahoma" Font-Size="9pt" ForeColor="#333333" GridLines="None" Width="100%" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("AtividadeId", "~/Etapas.aspx?id={0}")  %>' Text="Abrir"></asp:HyperLink>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="AtividadeId" HeaderText="Id" ReadOnly="True" SortExpression="AtividadeId">
                                                                        <ItemStyle Width="20px" />
                                                                    </asp:BoundField>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SGC_NET_V1ConnectionString1 %>" SelectCommand="SELECT Atividades.AtividadeId, Atividades.Nome, Subprocessos.Nome AS Subprocesso, Usuarios.Nome AS Responsavel FROM Subprocessos INNER JOIN Atividades ON Subprocessos.SubprocessoId = Atividades.SubprocessoId INNER JOIN Usuarios ON Atividades.ResponsavelId = Usuarios.UserID WHERE (Atividades.SubprocessoId = @SubprocessoId)">
                                                            <SelectParameters>
                                                                <asp:QueryStringParameter Name="SubprocessoId" QueryStringField="id" />
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
