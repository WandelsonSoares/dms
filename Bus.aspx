<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bus.aspx.cs" Inherits="Bus" %>
                            ...
                            <div>
                                <div>
                                    <ul class="nav nav-tabs">
                                        <li role="presentation" class="active"><a href="#">BUs</a></li>
                                            ...
                                            <td style="width: 0%;">
                                                <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Height="100%" Width="400px" Visible="False">
                                                    <div style="vertical-align: central; height: 100%; padding: 4px">
                                                        ...
                                                        <br />
                                                        <asp:Label ID="lblEmpresa" runat="server" CssClass="fontePadrao" Height="18px" Text="Empresa"></asp:Label>
                                                        <br />

                                                        <asp:DropDownList ID="DropDownListEmpresa" runat="server" Width="300px"></asp:DropDownList>
                                            ...
                                            <td style="width: 100%; padding: 4px">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <div>
                                                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" Font-Names="Tahoma" Font-Size="9pt" ForeColor="#333333" GridLines="None" Width="100%" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" OnRowCommand="GridViewBUs_RowCommand">
                                                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                                <Columns>

                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("BUId", "~/Departamentos.aspx?id={0}")  %>' Text="Abrir"></asp:HyperLink>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="BUId" HeaderText="BUId" ReadOnly="True" SortExpression="BUId">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SGC_NET_V1ConnectionString1 %>" SelectCommand="SELECT BUs.BUId, BUs.Nome AS BU, Empresas.Nome AS Empresa FROM BUs INNER JOIN Empresas ON BUs.EmpresaId = Empresas.EmpresaId WHERE (BUs.EmpresaId = @EmpresaId)">
                                                            <SelectParameters>
                                                                <asp:QueryStringParameter Name="EmpresaId" QueryStringField="id" />
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
